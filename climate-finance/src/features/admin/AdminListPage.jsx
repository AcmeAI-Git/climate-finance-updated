...
const AdminListPage = ({
        ...
        try {
            ...
            if (response.status) {
                ...
                if (Array.isArray(response.data)) {
                    ...
                    console.warn(
                        "No data received from API or invalid format:",
                        response
                    );
                    setData([]);
                    setFilteredData([]);
    ...
    const tableActions =
        customActions.length > 0 ? customActions : defaultActions;
                    ...
                    <Button
                        onClick={
                            ...
                            (() =>
                                navigate(
                                    entityName === "repository"
                                        ? `/admin/${entityName}/new`
                                        : `/admin/${entityName}s/new`
                                ))
                        }
                        variant="primary"
