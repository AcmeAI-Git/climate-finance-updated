...
const PieChartComponent = ({
    ...
    const transliterateType = (type) => {
        if (language === "bn") {
            ...
            if (type === "Active") return "সক্রিয়";
            if (type === "Completed") return "সম্পন্ন";
            if (type === "Total") return "মোট";
            if (type === "WASH Projects") return "ওয়াশ প্রকল্পসমূহ";
            if (type === "Climate Finance Only") return "নন-ওয়াশ প্রকল্পসমূহ";
        }
        return type;
    };
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            const tooltips = document.querySelectorAll(
                ".chartjs-tooltip, .chartjs-tooltip-box, .chartjs-tooltip-container, .chartjs-tooltip-content, .chartjs-tooltip-title, .chartjs-tooltip-body, .chartjs-tooltip-list, .chartjs-tooltip-label, .chartjs-tooltip-value, .chartjs-tooltip-percentage, .chartjs-tooltip-item, .chartjs-tooltip-header, .chartjs-tooltip-footer, .chartjs-tooltip-text, .chartjs-tooltip-inner, .chartjs-tooltip-outer, .chartjs-tooltip-wrap, .chartjs-tooltip-bg, .chartjs-tooltip-arrow, .chartjs-tooltip-pointer, .chartjs-tooltip-pointer-inner, .chartjs-tooltip-pointer-outer, .chartjs-tooltip-pointer-bg, .chartjs-tooltip-pointer-arrow, .chartjs-tooltip-pointer-arrow-inner, .chartjs-tooltip-pointer-arrow-outer, .chartjs-tooltip-pointer-arrow-bg, .chartjs-tooltip-pointer-arrow-pointer, .chartjs-tooltip-pointer-arrow-pointer-inner, .chartjs-tooltip-pointer-arrow-pointer-outer, .chartjs-tooltip-pointer-arrow-pointer-bg, .chartjs-tooltip-pointer-arrow-pointer-pointer"
            );
