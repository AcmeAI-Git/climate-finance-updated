...
const Routing = () => {
    return (
        <Routes>
            ...
            <Route
                path="/projects/new"
                element={<ProjectFormPage mode="public" />}
            />
            <Route
                path="/repository/new"
                element={<RepositoryFormPage mode="public" />}
            />
            <Route
            ...
            <Route
                path="/funding-sources/:sourceId"
                element={<FundingSourceDetails />}
            />
            <Route
                path="/funding-sources/new"
                element={
                    <ProtectedRoute>
            ...
            />
            <Route
                path="/admin/repository/new"
                element={
                    <AdminRoute>
                        <RepositoryFormPage mode="add" />
                    </AdminRoute>
                }
            />
            <Route
            ...
            <Route
                ...
                element={<Navigate to="/admin/agencies/new" replace />}
            />
            <Route
            ...
            <Route
                ...
                element={<Navigate to="/admin/funding-sources/new" replace />}
            />
            <Route
                path="/admin/funding-sources/new"
                element={
                    <AdminRoute>
                        <FundingSourceFormPage mode="add" />
                    </AdminRoute>
            ...
            />
            <Route
                path="/admin/funding-sources/:id/edit"
                element={
                    <AdminRoute>
                        <FundingSourceFormPage mode="edit" />
                    </AdminRoute>
            ...
            <Route
                ...
                element={<Navigate to="/admin/locations/new" replace />}
            />
            <Route
